      ...
      <div className="footer-content">
        ...
        <div className="footer-column">
          ...
          <p>
            ...
            amor y tradición desde las montañas del Huila.
          </p>
          
          {/* Redes Sociales - cambia los # por tus enlaces */}
          <div className="social-links">
            <a
              href="https://www.facebook.com/share/1cWX9oVyHB/?mibextid=wwXIfr"
            ...
            <a
              href="https://www.instagram.com/cancocafe?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
              className="social-link"
            ...
            <a
              href="https://www.tiktok.com/@cancostar?_r=1&_t=ZS-98VF1vb8Mjd"
              className="social-link"
              aria-label="TikTok"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="footer-column">
          <h3>Contacto</h3>
          <ul>
            <li><a href="tel:+573138115079">+57 313 811 5079</a></li>
